...
class _EnquiryDetailsState extends State<EnquiryDetails> {
  ...
  void quotationEnquiryFun() {
    Navigator.push(
        ...
        PageTransition(
            ...
            child: SubmitQuotationEnquiry(selectedItem: widget.selectedItem)));
  }
  ...
  Future<void> enquiryDetailApi() async {
    ...
    final json =
        '{"data": {"p1": $userId,"p2": 0,"p3": 0,"p4": 0,"p5": 0,"p6": "","p7": "","p8": "","p9": "","p10": "","p11": $pageIndex,"p12": $rowPerPage,"p13": "ENQUIRYDETAILS","p14": "$userGroupId","p15": "$userId"}}';
    final response =
  ...
  Widget mobile() {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Enquiry Detailed View'),
      ),
            ...
            Container(
                ...
                child: Column(children: [
                  ...
                  Row(
                    ...
                    children: [enquiryCode(130), noOfItems(130)],
                  ),
                  const SizedBox(height: 10),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [requiredDate(130), enquiryDate(130)],
                  ),
                  Row(
  ...
  Widget web() {
    final disableWidth = MediaQuery.of(context).size.width * 0.12;
    return Scaffold(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Row(
                    children: [
                      enquiryCode(disableWidth),
                      requiredDate(disableWidth),
                      enquiryDate(disableWidth),
                      noOfItems(disableWidth)
                    ],
                  ),
                  SizedBox(
                    width: 450,
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                          width: 150, child: Text('Make', style: tileHeader)),
                      SizedBox(
                          width: 150, child: Text('Model', style: tileHeader)),
                      SizedBox(
                          width: 150, child: Text('UOM', style: tileHeader)),
                      SizedBox(
                          width: 150,
  ...
  Widget requiredDate(double val) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
