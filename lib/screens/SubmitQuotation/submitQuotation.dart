...
import 'package:supplierportal/screens/SubmitQuotation/submitQuotationBill.dart';
...
class SubmitQuotation extends StatefulWidget {
  const SubmitQuotation({Key? key}) : super(key: key);

  @override
  State<SubmitQuotation> createState() => _SubmitQuotationState();
}

class _SubmitQuotationState extends State<SubmitQuotation> {
  String? ip;
                ...
                child: Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text('Submit Quotation', style: pageHeaderWeb),
                    ),
