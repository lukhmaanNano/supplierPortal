...
class SubmitQuotationModification extends StatefulWidget {
  String? materialName,
      uom,
      make,
      model,
  ...
  @override
  State<SubmitQuotationModification> createState() =>
      _SubmitQuotationModificationState();
}

class _SubmitQuotationModificationState
    extends State<SubmitQuotationModification> {
